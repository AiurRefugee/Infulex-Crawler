...
<template>
  <div class="filterWrapper flex justify-center items-center">
    <div class="w-full h-full filterIcon" @click="showFilter = !showFilter">
      <svg
        class="w-full h-full"
        t="1707469394304"
...
.mask {
  ...
  top: 0;
  z-index: $maskZindex;
  background-color: rgba(59, 59, 59, 0.762);
}
.filterIcon {
